...
<head>
    ...
    <title>Johan Felix - Product</title>
            ...
            <nav class="nav">
                ...
                <li class=" nav-item dropdown">
                    ...
                    <div class="dropdown-menu p-0 collapse" aria-labelledby="dropdown01" id="dd">
                        ...
                        <a id="btnProduct" class="dropdown-item active" href="<?= base_url(); ?>/Photo/Product">product</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
            ...
            <div class="previewContainer">
                <div class="previewArea">
                    ...
                    <div class="footerPreview">
                        <p class="footerPreviewText">photo / product</p>
                    </div>
                </div>
