...
<body>
    ...
    <section id="myWork">
        <div class="box">
            <nav class="nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu p-0 collapse" aria-labelledby="dropdown01" id="ee">
                        ...
                        <a class="dropdown-item active" href="<?= base_url(); ?>/Video/ShortMovie">short movie</a>
            ...
            <p class="pageIndicator">video / music video</p>
            ...
            <div class="previewContainer">
                <div class="previewArea" style="width:80%">
                    ...
                    <div class="footerPreview">
                        <p class="footerPreviewText">video / short movie</p>
                    </div>
                </div>
